...
[Inference result of RTM-KDOS.mp4] This video demonstrates RTM‑KDOS accurately predicting keypoints and simultaneously outputting operability scores (not confidence). The operability score varies with the viewing angle and reaches its peak when the three keypoints lie on the same plane. RTM‑KDOS performs consistently under both front‑lighting and backlit conditions.
